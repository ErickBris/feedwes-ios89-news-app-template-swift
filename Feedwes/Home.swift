...
func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (Int64)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), {
        ...
        // Get Journal's name
        if post.pPostLink.hasPrefix("http://www.bbc.co.uk") {
            cell.journalLabel.text = "BBC NEWS"
        } else if post.pPostLink.hasPrefix("http://rss.nytimes.com") {
            cell.journalLabel.text = "NEW YORK TIMES"
        } else if post.pPostLink.hasPrefix("http://www.forbes.com") {
